	...
	<form action="" method="post">
		<ul>
			...
			<li>
				...
				<input type="text" email="email" id="email" name="email" required>
			</li>
			<br>
			<li>
				<label for="job">Job :</label>
				<input type="text" job="job" id="job" name="job" required>
			</li>
			<br>
			<li>
				<label for="image">Image :</label>
				<input type="text" image="image" id="image" name="image">
			</li>
		</ul>
